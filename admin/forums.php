...
?>
					<!-- Categories Start -->
					<div id="pannelAdminForums" class="panel panel-default">
						<div class="panel-heading">
							Categories
							<button  type="button" class="btn btn-xs btn-success pull-right" data-toggle="collapse" data-target="#newForumWell">New Forums</button>
						</div>
